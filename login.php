      ...
      <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
        <li class="nav-item dropdown">
          <a href="index.php" class="navbar-brand mr-lg-5 text-white">
            <h3 style="color: white; font-family:Verdana, Geneva, Tahoma, sans-serif;">Exam Portal</h3>   
        ...
        <div class="col-12">
          <form class="col s12 l5 white-text" method="POST" autocomplete="new-password">
            <div class="form-group row">
              <label class="col-md-2 col-form-label text-white" for="email">Staff ID</label>
                <div class="col-md-10">
                  <input autocomplete="new-password" class="white-text validate form-control" placeholder="Staff ID" id="email" name="staffid" type="text" class="validate"/>
                </div>
            </div>
			      <div class="form-group row">
