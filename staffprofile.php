          ...
          <ul class="navbar-nav align-items-lg-center ml-auto">
			 ...
			 <li class="nav-item">
              <a href="quizlist.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-white fad fa-poll"></i> Subjects</span
                >
              </a>
            </li>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="card-body bg-gradient-warning">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="assets/img/uvce_vector.png" alt="student" class="rounded-circle" width="177">
                    <div class="mt-3">
                      <h4>                      <?php echo $dbname ?></h4>
                      <p class="text-white mb-1"> <?php echo $dbdept ?> Engineering</p>
                      <p class="text-white font-size-sm">University of Visvesvaraya College of Engineering</p>
