              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input
					...
					pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                  />
				   <p>  <small class="text-white"> Use minimum 8 Characters with at least 1 numericals, Capital letter and Special Character.  </small></p>
                </div>
              </div>
          ...
          <div class="modal-body bg-gradient-primary">
            ...
            >
              ...
              <div class="form-group row">
			   ...
			   <div class="form-group row">
                <label class="col-md-2 col-form-label text-white" for="cpassword1">Confirm Password</label>
                <div class="col-md-10">
                  <input type="password" name="cpassword1" class=" form-control" required placeholder="**********" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"/>
				  				   <p><small class="text-white"> Enter the same password as before, for verification. </small></p>
                </div>
              </div>
              <div class="form-group row">
                <div class="offset-md-2 col-md-10">
                  <button class="btn btn-success form-control" type="submit" name="studsu">Sign Up</button>
                </div>
              </div>
            </form>
          </div>
